...
use Models\Models\Cities;
use Models\Models\CitiesQuery;
...
class CitiesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Models.Models.Map.CitiesTableMap';
     ...
     */
    const OM_CLASS = '\\Models\\Models\\Cities';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Models.Models.Cities';
     ...
     */
    const COL_NAME = 'cities.name';

    /**
     * the column name for the county_id field
     */
    const COL_COUNTY_ID = 'cities.county_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'CountyId', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'countyId', ),
        self::TYPE_COLNAME       => array(CitiesTableMap::COL_ID, CitiesTableMap::COL_NAME, CitiesTableMap::COL_COUNTY_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'county_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'CountyId' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'countyId' => 2, ),
        self::TYPE_COLNAME       => array(CitiesTableMap::COL_ID => 0, CitiesTableMap::COL_NAME => 1, CitiesTableMap::COL_COUNTY_ID => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'county_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Models\\Models\\Cities');
        $this->setPackage('Models.Models');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('name', 'Name', 'VARCHAR', false, 255, null);
        $this->addForeignKey('county_id', 'CountyId', 'INTEGER', 'counties', 'id', false, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('Counties', '\\Models\\Models\\Counties', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':county_id',
    1 => ':id',
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Places', '\\Models\\Models\\Places', RelationMap::MANY_TO_MANY, array(), null, null, 'Placess');
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CitiesTableMap::COL_NAME);
            $criteria->addSelectColumn(CitiesTableMap::COL_COUNTY_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Models\Models\Cities) { // it's a model object
